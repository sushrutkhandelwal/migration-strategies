...
void UDPBasicApp::finish()
{
    ...
    EV_INFO << getFullPath() << ": sent " << numSent << " packets\n";
  //  ReceptionIndication *indication=const_cast<ReceptionIndication *>(ReceiverBase::computeReceptionIndication(snir));
    //double rssiValue= inet::math::mW2dBm(indication->getMinRSSI().get() * 1000);
    //recordScalar("rssi-",rssiValue);
